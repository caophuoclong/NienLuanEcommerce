    ...
    <div className='px-[2rem]'>
      ...
      <div className="grid grid-cols-2 bg-white">
        ...
        <div className="block col-start-2 w-full">
          ...
          < div className="justify-between  gap-1">
            <div className="gap-4 flex text-1xl">
              Màu sắc: 
                ...
                <button className='bg-white hover:bg-gray-400 w-10  mr-3'>Trắng</button>
            </div>
          ...
          <button className="text-white hover:bg-blue-500 flex flex-1 items-center justify-center bg-green-400 group gap-x-2 h-10 ml-3 mt-6">
