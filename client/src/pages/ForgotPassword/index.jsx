                ...
                <div className="bg-white w-full h-full z-50  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]">
                    <div className="flex space-y-5 flex-col h-full justify-center items-center">
                        ...
                        <div className="text-slate-400">
                            <p>We get it, stuff happens. Just enter your email address<br /> below and we'll send you a link to reset passwoord!</p>
                        </div>
                        ...
                        <div className="flex justify-center w-64 mb-5">
                            <p className="text-sm">Already an Account? <span className='text-gray-400 font-bold underline underline-offset-4'><Link to={"/signin"}>SignIn</Link></span></p>
                        </div>
                    </div>
                </div>
